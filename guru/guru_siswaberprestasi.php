...
<body>
  ...
  <div class="main-content">
    ...
    <div class="main" style="flex-direction:column;align-items:center;justify-content:flex-start;gap:2.5rem;min-height:70vh;">
      <div class="prestasi-cards-container" style="display:flex;flex-wrap:wrap;gap:2.2rem;justify-content:center;width:100%;max-width:1200px;">
        <!-- Card Juara Nilai Rata-rata -->
        <div class="prestasi-card card-nilai">
          <div class="watermark-icon"><img src="../img/piala.png" alt="Piala"></div>
          <div class="card-content">
            <div style="font-size:1.3rem;font-weight:700;color:#335165;text-align:center;margin-bottom:0.7rem;letter-spacing:0.5px;">Juara Nilai Rata-rata Tertinggi</div>
            <ol class="juara-list" style="list-style:none;padding:0;margin:0;display:flex;flex-direction:column;gap:1.1rem;">
              <li class="juara-item" style="display:flex;align-items:center;gap:1rem;background:rgba(255,255,255,0.85);border-radius:14px;padding:0.8rem 1.2rem;box-shadow:0 2px 8px #b8355633;animation:fadeIn 1.2s 0.1s both;">
                <span style="font-size:2.1rem;font-weight:900;color:#FFD700;filter:drop-shadow(0 2px 8px #FFD70055);">🥇</span>
                <span style="font-size:1.1rem;font-weight:700;color:#335165;">Nadia Putri</span>
              </li>
              <li class="juara-item" style="display:flex;align-items:center;gap:1rem;background:rgba(255,255,255,0.75);border-radius:14px;padding:0.8rem 1.2rem;box-shadow:0 2px 8px #b8355633;animation:fadeIn 1.2s 0.2s both;">
                <span style="font-size:2.1rem;font-weight:900;color:#C0C0C0;filter:drop-shadow(0 2px 8px #C0C0C055);">🥈</span>
                <span style="font-size:1.1rem;font-weight:700;color:#335165;">Galih Pratama</span>
              </li>
              <li class="juara-item" style="display:flex;align-items:center;gap:1rem;background:rgba(255,255,255,0.65);border-radius:14px;padding:0.8rem 1.2rem;box-shadow:0 2px 8px #b8355633;animation:fadeIn 1.2s 0.3s both;">
                <span style="font-size:2.1rem;font-weight:900;color:#CD7F32;filter:drop-shadow(0 2px 8px #CD7F3255);">🥉</span>
                <span style="font-size:1.1rem;font-weight:700;color:#335165;">Citra Dewi</span>
              </li>
            </ol>
          </div>
        </div>
        <!-- Card Juara Keaktifan Ekstrakurikuler -->
        <div class="prestasi-card card-ekstra">
          <div class="watermark-icon"><img src="../img/aktivitas.png" alt="Aktif"></div>
          <div class="card-content">
            <div style="font-size:1.3rem;font-weight:700;color:#fff;text-align:center;margin-bottom:0.7rem;letter-spacing:0.5px;text-shadow:0 2px 8px #b8355633;">Juara Keaktifan Ekstrakurikuler</div>
            <ol class="juara-list" style="list-style:none;padding:0;margin:0;display:flex;flex-direction:column;gap:1.1rem;">
              <li class="juara-item" style="display:flex;align-items:center;gap:1rem;background:rgba(255,255,255,0.85);border-radius:14px;padding:0.8rem 1.2rem;box-shadow:0 2px 8px #b8355633;animation:fadeIn 1.2s 0.1s both;">
                <span style="font-size:2.1rem;font-weight:900;color:#FFD700;filter:drop-shadow(0 2px 8px #FFD70055);">🥇</span>
                <span style="font-size:1.1rem;font-weight:700;color:#335165;">Galih Pratama</span>
              ...
              <li class="juara-item" style="display:flex;align-items:center;gap:1rem;background:rgba(255,255,255,0.75);border-radius:14px;padding:0.8rem 1.2rem;box-shadow:0 2px 8px #b8355633;animation:fadeIn 1.2s 0.2s both;">
                <span style="font-size:2.1rem;font-weight:900;color:#C0C0C0;filter:drop-shadow(0 2px 8px #C0C0C055);">🥈</span>
                <span style="font-size:1.1rem;font-weight:700;color:#335165;">Eko Prasetyo</span>
              </li>
              <li class="juara-item" style="display:flex;align-items:center;gap:1rem;background:rgba(255,255,255,0.65);border-radius:14px;padding:0.8rem 1.2rem;box-shadow:0 2px 8px #b8355633;animation:fadeIn 1.2s 0.3s both;">
                <span style="font-size:2.1rem;font-weight:900;color:#CD7F32;filter:drop-shadow(0 2px 8px #CD7F3255);">🥉</span>
                <span style="font-size:1.1rem;font-weight:700;color:#335165;">Maman Suparman</span>
              </li>
            </ol>
          </div>
        </div>
...
.prestasi-card.card-nilai {
  background: linear-gradient(135deg,  #ffe066 60%, #ffd700 100%);
}
.prestasi-card.card-ekstra {
  background: linear-gradient(135deg, #4d65ffff 60%, #342dfcff 100%);
}
.prestasi-card:hover {
...
.watermark-icon img {
  ...
  height: 350px;
  object-fit: contain;
  filter: drop-shadow(0 4px 24px #fff8) drop-shadow(0 2px 8px #ffd70088);
}
.card-content {
  z-index: 1;
  width: 100%;
...
.card-nilai .card-content > div:first-child {
  color: #b8860b;
  text-shadow: 0 2px 8px #fff7, 0 1px 4px #ffd70055;
}
.card-ekstra .card-content > div:first-child {
  color: #c85000;
  text-shadow: 0 2px 8px #fff7, 0 1px 4px #ffb06655;
}
.juara-list {
  list-style: none;
  padding: 0;
...
.juara-item span:first-child {
  font-size: 2.2rem;
  font-weight: 900;
  margin-right: 0.2rem;
}
.card-nilai .juara-item span:last-child {
  color: #b8860b;
  font-weight: 800;
}
.card-ekstra .juara-item span:last-child {
  color: #c85000;
  font-weight: 800;
}
.juara-item:hover {
...
.card-ekstra .juara-item:hover {
  background: #fff4e6 !important;
  box-shadow: 0 4px 16px #ffb06655;
}
@media screen and (max-width: 900px) {
